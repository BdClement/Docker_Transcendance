document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadFriendLists() {
        ...
        .catch(error => {
            ...
            followingList.innerHTML = '<li class="custom-list-group-item text-danger">Erreur lors du chargement des amis</li>';
        });
        ...
        .then(data => {
            if (data.length === 0) {
                followersList.innerHTML = '<li class="custom-list-group-item text-muted">Aucun abonné</li>';
                return;
            }
        ...
        .catch(error => {
            console.error('Erreur:', error);
            followersList.innerHTML = '<li class="custom-list-group-item text-danger">Erreur lors du chargement des followers</li>';
        });
    }
